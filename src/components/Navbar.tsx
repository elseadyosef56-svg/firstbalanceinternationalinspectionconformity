    ...
    <nav className="fixed top-0 right-0 left-0 z-50 bg-card/90 backdrop-blur-md border-b border-border shadow-luxury">
      <div className="container mx-auto flex items-center justify-between py-3">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-11 h-11 rounded-lg overflow-hidden bg-white p-1 shadow-md group-hover:shadow-gold transition-shadow duration-300 flex-shrink-0 ring-1 ring-accent/20">
